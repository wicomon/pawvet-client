...
export default function CheckboxField({ label, name, helperText }: CheckboxFieldProps) {
  ...
  return (
    <label
      htmlFor={fieldId}
      className="flex cursor-pointer items-start gap-2.5 rounded-[10px] border-[1.5px] border-wv-btn-border bg-white px-[15px] py-3 transition-colors duration-150 ease-out hover:bg-wv-mint-soft/40"
    >
      <input
        {...field}
        id={fieldId}
        ...
        className="mt-[3px] h-4 w-4 shrink-0 accent-wv-teal"
      />
