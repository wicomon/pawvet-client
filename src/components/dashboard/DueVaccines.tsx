  ...
  return (
    <section className="flex flex-col gap-3.5 rounded-2xl border border-wv-border bg-card px-6 py-[22px]">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-full bg-wv-amber-bg px-2.5 py-[3px] text-[11px] font-extrabold text-wv-amber-ink">
          Esta semana
        </span>
      </div>
      ...
      <div className="flex flex-col gap-2">
        {DUE_VACCINES.map((vaccine) => (
          ...
          >
            <div className="grid h-[34px] w-[34px] shrink-0 place-items-center rounded-full bg-wv-mint-soft font-heading text-xs font-bold text-wv-teal-deep">
              {vaccine.initials}
            </div>
            ...
            <button
              type="button"
              className="cursor-pointer whitespace-nowrap rounded-lg bg-wv-mint-soft px-3 py-[7px] text-xs font-extrabold text-wv-teal-deep outline-none transition-colors duration-150 ease-out hover:bg-wv-mint-soft/70 focus-visible:shadow-focus"
            >
              Recordar WA
            </button>
          </div>
