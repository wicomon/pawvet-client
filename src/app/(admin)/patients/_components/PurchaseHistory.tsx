    ...
    <section className="flex flex-col gap-3.5 rounded-2xl border border-wv-border bg-card px-6 py-5.5">
      ...
      <div className="flex flex-col gap-1.5">
        {OWNER_PURCHASES.map((purchase) => (
          <div
            key={purchase.date}
            className="flex flex-wrap items-center gap-3.5 rounded-[10px] border border-wv-row-border px-3.5 py-3.25"
          >
            <span className="w-27.5 shrink-0 font-heading text-[13.5px] font-bold text-wv-navy">
              {purchase.date}
            </span>
