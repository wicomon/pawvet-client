...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-page flex items-center justify-center p-10">
      <div className="w-[440px] max-w-full bg-card border border-subtle rounded-card shadow-card px-9 py-11 flex flex-col items-center text-center gap-2.5">
        ...
        <Link
          href="/"
          className="mt-3.5 h-[46px] px-6 rounded-field bg-brand hover:bg-brand-hover text-on-brand font-display font-bold text-sm flex items-center transition-[transform,background-color] duration-200 active:scale-[0.97]"
        >
          Volver al panel
        </Link>
      </div>
